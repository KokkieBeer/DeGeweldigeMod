...
public class CheeseFarmLand extends Block {
	...
	public boolean canSustainPlant(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing direction, IPlantable plantable) {
		if(plantable.getPlantType(world, pos) != null) {
			if(plantable.getPlantType(world, pos) == EnumPlantType.Crop) {
				return true;
			}
		}
		return false;
	...
	public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos,
		...
		case EAST:
			...
			return !iblockstate.isOpaqueCube() && block != CheeseBlocks.CHEESE_FARM_LAND
					&& block != CheeseBlocks.CHEESE_GRASS_PATH;
		default:
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return CheeseBlocks.CHEESE_DIRT.getItemDropped(CheeseBlocks.CHEESE_DIRT.getDefaultState(), rand, fortune);
	}

	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(CheeseBlocks.CHEESE_DIRT);
	}
