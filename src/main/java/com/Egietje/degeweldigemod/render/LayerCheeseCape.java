...
public class LayerCheeseCape implements LayerRenderer<AbstractClientPlayer> {
	private final RenderPlayer playerRenderer;

	public LayerCheeseCape(RenderPlayer playerRendererIn) {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		if (!entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE)) {
			...
			if (itemstack.getItem() != Items.ELYTRA) {
				...
				this.playerRenderer.bindTexture(new ResourceLocation(Reference.MODID + ":textures/entity/cheese_cape.png"));
