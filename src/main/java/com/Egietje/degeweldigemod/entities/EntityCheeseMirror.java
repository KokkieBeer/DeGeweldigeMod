...
public class EntityCheeseMirror extends Entity {
	private Minecraft mc = Minecraft.getMinecraft();

	private int facing;
	public boolean rendering;

	public EntityCheeseMirror(World worldIn) {
		super(worldIn);
	}

	public EntityCheeseMirror(World worldIn, double x, double y, double z, EnumFacing facing) {
		super(worldIn);
	...
	public void onUpdate() {
		...
		if (!(world.getBlockState(getPosition().down()).getBlock() instanceof CheeseMirror)) {
			RenderCheeseMirror.removeRegisteredMirror(this);
			this.setDead();
		}
	}
