...
public class RenderCheeseBall extends Render<EntityCheeseBall> {
	private final float scale;

	public RenderCheeseBall(RenderManager renderManagerIn, float scaleIn) {
	 ...
	 */
	public void doRender(EntityCheeseBall entity, double x, double y, double z, float entityYaw, float partialTicks) {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityCheeseBall entity) {
