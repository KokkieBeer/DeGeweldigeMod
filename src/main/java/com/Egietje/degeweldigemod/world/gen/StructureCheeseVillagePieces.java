...
public class StructureCheeseVillagePieces {
	public static void registerVillagePieces() {
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.House1.class, "CViBH");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Field1.class, "CViDF");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Field2.class, "CViF");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Torch.class, "CViL");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Hall.class, "CViPH");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.House4Garden.class, "CViSH");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.WoodHut.class, "CViSmH");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Church.class, "CViST");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.House2.class, "CViS");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Start.class, "CViStart");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Path.class, "CViSR");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.House3.class, "CViTRH");
		MapGenStructureIO.registerStructureComponent(StructureCheeseVillagePieces.Well.class, "CViW");
	}

	public static List<StructureCheeseVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random,
			int size) {
		List<StructureCheeseVillagePieces.PieceWeight> list = Lists.<StructureCheeseVillagePieces.PieceWeight>newArrayList();
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.House4Garden.class, 4,
				MathHelper.getInt(random, 2 + size, 4 + size * 2)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.Church.class, 20,
				MathHelper.getInt(random, 0 + size, 1 + size)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.House1.class, 20,
				MathHelper.getInt(random, 0 + size, 2 + size)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.WoodHut.class, 3,
				MathHelper.getInt(random, 2 + size, 5 + size * 3)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.Hall.class, 15,
				MathHelper.getInt(random, 0 + size, 2 + size)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.Field1.class, 3,
				MathHelper.getInt(random, 1 + size, 4 + size)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.Field2.class, 3,
				MathHelper.getInt(random, 2 + size, 4 + size * 2)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.House2.class, 15,
				MathHelper.getInt(random, 0, 1 + size)));
		list.add(new StructureCheeseVillagePieces.PieceWeight(StructureCheeseVillagePieces.House3.class, 8,
				MathHelper.getInt(random, 0 + size, 3 + size * 2)));
		Iterator<StructureCheeseVillagePieces.PieceWeight> iterator = list.iterator();

		while (iterator.hasNext()) {
			if (((StructureCheeseVillagePieces.PieceWeight) iterator.next()).villagePiecesLimit == 0) {
				iterator.remove();
			}
		}
	...
	private static int updatePieceWeight(List<StructureCheeseVillagePieces.PieceWeight> p_75079_0_) {
		boolean flag = false;
		int i = 0;

		for (StructureCheeseVillagePieces.PieceWeight structurevillagepieces$pieceweight : p_75079_0_) {
	...
	private static StructureCheeseVillagePieces.Village findAndCreateComponentFactory(
			StructureCheeseVillagePieces.Start start, StructureCheeseVillagePieces.PieceWeight weight,
		...
		Class<? extends StructureCheeseVillagePieces.Village> oclass = weight.villagePieceClass;
		StructureCheeseVillagePieces.Village structurevillagepieces$village = null;

		if (oclass == StructureCheeseVillagePieces.House4Garden.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.House4Garden.createPiece(start,
					structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.Church.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.Church.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.House1.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.House1.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.WoodHut.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.WoodHut.createPiece(start,
					structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.Hall.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.Hall.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.Field1.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.Field1.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.Field2.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.Field2.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.House2.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.House2.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		} else if (oclass == StructureCheeseVillagePieces.House3.class) {
			structurevillagepieces$village = StructureCheeseVillagePieces.House3.createPiece(start, structureComponents,
					rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
	...
	private static StructureCheeseVillagePieces.Village generateComponent(StructureCheeseVillagePieces.Start start,
			List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY,
			int structureMinZ, EnumFacing facing, int componentType) {
		...
		if (i <= 0) {
			...
			while (j < 5) {
				...
				for (StructureCheeseVillagePieces.PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList) {
					...
					if (k < 0) {
						...
						StructureCheeseVillagePieces.Village structurevillagepieces$village = findAndCreateComponentFactory(
			...
			StructureBoundingBox structureboundingbox = StructureCheeseVillagePieces.Torch.findPieceBox(start,
					structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

			if (structureboundingbox != null) {
				return new StructureCheeseVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing);
			} else {
				return null;
			}
		}
	...
	private static StructureComponent generateAndAddComponent(StructureCheeseVillagePieces.Start start,
			List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY,
			int structureMinZ, EnumFacing facing, int componentType) {
		if (componentType > 50) {
			return null;
	...
	private static StructureComponent generateAndAddRoadPiece(StructureCheeseVillagePieces.Start start,
		...
		if (p_176069_7_ > 3 + start.terrainType) {
			...
			StructureBoundingBox structureboundingbox = StructureCheeseVillagePieces.Path.findPieceBox(start,
					p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

			if (structureboundingbox != null && structureboundingbox.minY > 10) {
				StructureComponent structurecomponent = new StructureCheeseVillagePieces.Path(start, p_176069_7_, rand,
	...
	public static class Church extends StructureCheeseVillagePieces.Village {
		public Church() {
		}

		public Church(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_,
				EnumFacing facing) {
			super(start, type);
		...
		public static StructureCheeseVillagePieces.Church createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox,
									facing)
							: null;
		}
	...
	public static class Field1 extends StructureCheeseVillagePieces.Village {
		...
		public Field1(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCheeseVillagePieces.Field1 createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			for (int j2 = 0; j2 < 9; ++j2) {
				for (int k2 = 0; k2 < 13; ++k2) {
					...
					this.replaceAirAndLiquidDownwards(worldIn, CheeseBlocks.CHEESE_DIRT.getDefaultState(), k2, -1, j2,
							structureBoundingBoxIn);
				}
			}
	...
	public static class Field2 extends StructureCheeseVillagePieces.Village {
		/** First crop type for this field. */
		private Block cropTypeA;
		/** Second crop type for this field. */
		private Block cropTypeB;
		...
		public Field2(StructureCheeseVillagePieces.Start start, int p_i45569_2_, Random rand,
		...
		public static StructureCheeseVillagePieces.Field2 createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			for (int j1 = 0; j1 < 9; ++j1) {
				for (int k1 = 0; k1 < 7; ++k1) {
					...
					this.replaceAirAndLiquidDownwards(worldIn, CheeseBlocks.CHEESE_DIRT.getDefaultState(), k1, -1, j1,
							structureBoundingBoxIn);
				}
			}
	...
	public static class Hall extends StructureCheeseVillagePieces.Village {
		public Hall() {
		}

		public Hall(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCheeseVillagePieces.Hall createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(),
					Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 0, 6, 8, 0, 10, CheeseBlocks.CHEESE_DIRT.getDefaultState(),
					CheeseBlocks.CHEESE_DIRT.getDefaultState(), false);
	...
	public static class House1 extends StructureCheeseVillagePieces.Village {
		public House1() {
		}

		public House1(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCheeseVillagePieces.House1 createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.House1(start, p_175850_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.setBlockState(worldIn, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 4, 2, 3,
					structureBoundingBoxIn);
			this.setBlockState(worldIn, CheeseBlocks.CHEESE_CRAFTING_TABLE.getDefaultState(), 7, 1, 1, structureBoundingBoxIn);
	...
	public static class House2 extends StructureCheeseVillagePieces.Village {
		private boolean hasMadeChest;

		public House2() {
		}

		public House2(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCheeseVillagePieces.House2 createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.House2(start, p_175855_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.setBlockState(worldIn, CheeseBlocks.CHEESE_FURNACE.getDefaultState(), 6, 2, 3, structureBoundingBoxIn);
			this.setBlockState(worldIn, CheeseBlocks.CHEESE_FURNACE.getDefaultState(), 6, 3, 3, structureBoundingBoxIn);
	...
	public static class House3 extends StructureCheeseVillagePieces.Village {
		public House3() {
		}

		public House3(StructureCheeseVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_,
				EnumFacing facing) {
			super(start, type);
			this.setCoordBaseMode(facing);
		...
		public static StructureCheeseVillagePieces.House3 createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox,
									facing)
							: null;
		}
	...
	public static class House4Garden extends StructureCheeseVillagePieces.Village {
		private boolean isRoofAccessible;

		public House4Garden() {
		}

		public House4Garden(StructureCheeseVillagePieces.Start start, int p_i45566_2_, Random rand,
		...
		public static StructureCheeseVillagePieces.House4Garden createPiece(StructureCheeseVillagePieces.Start start,
			...
			return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null
					: new StructureCheeseVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox,
							facing);
		}
	...
	public static class Path extends StructureCheeseVillagePieces.Road {
		private int length;

		public Path() {
		}

		public Path(StructureCheeseVillagePieces.Start start, int p_i45562_2_, Random rand,
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			...
			for (int i = rand.nextInt(5); i < this.length - 8; i += 2 + rand.nextInt(5)) {
				StructureComponent structurecomponent = this
						.getNextComponentNN((StructureCheeseVillagePieces.Start) componentIn, listIn, rand, 0, i);
			...
			for (int j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
				StructureComponent structurecomponent1 = this
						.getNextComponentPP((StructureCheeseVillagePieces.Start) componentIn, listIn, rand, 0, j);
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null) {
				...
				case NORTH:
				default:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.minX - 1,
							this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
					break;
				case SOUTH:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.minX - 1,
							this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
					break;
				case WEST:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.minX,
							this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH,
							this.getComponentType());
					break;
				case EAST:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.maxX - 2,
							this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH,
							this.getComponentType());
				}
			}
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null) {
				...
				default:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.maxX + 1,
							this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
					break;
				case SOUTH:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.maxX + 1,
							this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
					break;
				case WEST:
					StructureCheeseVillagePieces.generateAndAddRoadPiece(
							(StructureCheeseVillagePieces.Start) componentIn, listIn, rand, this.boundingBox.minX,
		...
		public static StructureBoundingBox findPieceBox(StructureCheeseVillagePieces.Start start,
	...
	public static class PieceWeight {
		public Class<? extends StructureCheeseVillagePieces.Village> villagePieceClass;
		public final int villagePieceWeight;
		public int villagePiecesSpawned;
		public int villagePiecesLimit;

		public PieceWeight(Class<? extends StructureCheeseVillagePieces.Village> p_i2098_1_, int p_i2098_2_,
				int p_i2098_3_) {
	...
	public abstract static class Road extends StructureCheeseVillagePieces.Village {
		public Road() {
		}

		protected Road(StructureCheeseVillagePieces.Start start, int type) {
			super(start, type);
		}
	}

	public static class Start extends StructureCheeseVillagePieces.Well {
		public BiomeProvider worldChunkMngr;
		/** World terrain type, 0 for normal, 1 for flap map */
		public int terrainType;
		public StructureCheeseVillagePieces.PieceWeight structVillagePieceWeight;
		public List<StructureCheeseVillagePieces.PieceWeight> structureVillageWeightedPieceList;
		...
		public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_,
				List<StructureCheeseVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_) {
			super((StructureCheeseVillagePieces.Start) null, 0, rand, p_i2104_4_, p_i2104_5_);
	...
	public static class Torch extends StructureCheeseVillagePieces.Village {
		public Torch() {
		}

		public Torch(StructureCheeseVillagePieces.Start start, int p_i45568_2_, Random rand,
	...
	public abstract static class Village extends StructureComponent {
		...
		protected StructureCheeseVillagePieces.Start startPiece;

		public Village() {
		}

		protected Village(StructureCheeseVillagePieces.Start start, int type) {
			super(type);
		 ...
		 */
		@Nullable
		protected StructureComponent getNextComponentNN(StructureCheeseVillagePieces.Start start,
			...
			if (enumfacing != null) {
				...
				case NORTH:
				default:
					return StructureCheeseVillagePieces.generateAndAddComponent(start, structureComponents, rand,
		 ...
		 */
		@Nullable
		protected StructureComponent getNextComponentPP(StructureCheeseVillagePieces.Start start,
			...
			if (this.villagersSpawned < count) {
				for (int i = this.villagersSpawned; i < count; ++i) {
					...
					if (this.isZombieInfested) {
						...
						entityvillager.finalizeMobSpawn(worldIn.getDifficultyForLocation(new BlockPos(entityvillager)),
	...
	public static class Well extends StructureCheeseVillagePieces.Village {
		public Well() {
		}

		public Well(StructureCheeseVillagePieces.Start start, int type, Random rand, int x, int z) {
			super(start, type);
		 ...
		 */
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureCheeseVillagePieces.Start) componentIn,
					listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1,
					EnumFacing.WEST, this.getComponentType());
			StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureCheeseVillagePieces.Start) componentIn,
					listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1,
					EnumFacing.EAST, this.getComponentType());
			StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureCheeseVillagePieces.Start) componentIn,
					listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1,
					EnumFacing.NORTH, this.getComponentType());
			StructureCheeseVillagePieces.generateAndAddRoadPiece((StructureCheeseVillagePieces.Start) componentIn,
					listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1,
	...
	public static class WoodHut extends StructureCheeseVillagePieces.Village {
		...
		public WoodHut(StructureCheeseVillagePieces.Start start, int type, Random rand,
		...
		public static StructureCheeseVillagePieces.WoodHut createPiece(StructureCheeseVillagePieces.Start start,
			...
			return canVillageGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null
							? new StructureCheeseVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox,
									facing)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 2, 0, 3, CheeseBlocks.CHEESE_DIRT.getDefaultState(),
					CheeseBlocks.CHEESE_DIRT.getDefaultState(), false);
